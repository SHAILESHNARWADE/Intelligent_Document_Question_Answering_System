...
#
# Author       : Shailesh Kalyan Narwade
# Date         : 30/05/2026
#
# Description  :
...
st.markdown(
    '<div class="main-title">SmartDoc AI</div>',
    unsafe_allow_html=True
)
...
<b>Author:</b> Shailesh Kalyan Narwade<br>
                 
<b>Date:</b> 30/05/2026<br><br>

<b>Technology:</b><br>
Python, Streamlit, PyPDF2, Sentence Transformers, FAISS, Ollama, phi3:mini<br><br>
...
with tab3:
    ...
    ### 7. LLM
    phi3:mini running locally through Ollama generates final response.
...
<hr>
<b>SmartDoc AI</b><br>
Smarter Search. Faster Insights !!!<br>
Project developed by Shailesh Kalyan Narwade | Date: 30/05/2026
</div>
""", unsafe_allow_html=True)